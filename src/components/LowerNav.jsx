...
const LowerNav = () => {
  ...
  return (
    <div className="flex bg-white/20 w-full py-2 backdrop-blur-sm justify-evenly text-white text-xl md:text-3xl items-center h-full rounded-xl">
      {icons?.map((elem, index) => (
        ...
        >
          {({ isActive }) => (
            <>
              <i
                className={`${elem.iconCode}   ${isActive ? "text-yellow-200" : ""}`}
              ></i>
              <div
                id="circle"
