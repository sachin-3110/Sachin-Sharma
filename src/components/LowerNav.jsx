...
const LowerNav = () => {
  ...
  return (
    <div className="flex fixed bottom-4 bg-[#45414176] justify-evenly text-white text-2xl md:text-3xl items-center min-h-[8vh] md:h-[8vh] mb-5 border-[1px] w-[40%] rounded-2xl">
