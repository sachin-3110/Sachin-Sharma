  ...
  return (
    ...
    >
      ...
      <div className="mt-10 max-w-7xl mx-auto w-full">
        {/* Availability Badge */}
        <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-8">
            ...
            >
              CRAFTING <br />
              <span className="text-white/40 italic font-light">DIGITAL</span> <br />
              EXPERIENCES
            </motion.h1>
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap items-center gap-6">
              ...
              <div className="flex flex-wrap gap-3">
                {techStack.map((tech) => (
                  ...
                  >
                    <tech.icon size={16} className="text-white/40 group-hover:text-white transition-colors" />
          ...
          <div className="hidden lg:block lg:col-span-4 border-l border-white/10 pl-12">
            <motion.div variants={itemVariants} className="space-y-12">
              ...
              <div>
                <h3 className="text-white/30 text-sm font-bold uppercase tracking-widest mb-4">Socials</h3>
