...
const TopNav = () => {
  ...
  return (
    ...
    >
      ...
      <div id="time" className="p-3 flex justify-evenly items-center">
        <div className="text-2xl flex md:gap-1">
          <h1>{date[0]}/</h1>
          <h1>{date[1]}/</h1>
          <h1>{date[2]?.split(",")[0]}</h1>
        </div>
        <div className="text-2xl min-w-40 border-2 justify-center rounded flex gap-1 font-bold text-yellow-200">
